  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-lg bg-white border border-gray-200 p-4 shadow-sm">
        <h3 className="text-sm font-semibold text-gray-700 mb-3">Trigger AML Screen</h3>
        <div className="flex gap-2">
          <input
            ...
            className="rounded-md border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 w-72 font-mono"
          />
          <button
