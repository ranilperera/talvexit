...
export function buildFullScopePrompt(
  input: GenerateScopeInput & {
    currency?: string; // customer's preferred currency if not AUD
  },
...
// Builds a targeted prompt to regenerate ONE section.
// Uses existing scope as context so other sections stay coherent.
