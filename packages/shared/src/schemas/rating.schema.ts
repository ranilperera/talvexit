...
// ─── determinationSchema ──────────────────────────────────────────────────────
// Accepts both legacy executive (FULL_PAYMENT / PARTIAL_PAYMENT / FULL_REFUND /
// REMEDY_REQUIRED) and Phase 3 advisory shapes. The dispute service branches
// on cutover and validates the relevant fields per path.
